...
| [nimo-verification-create](skills/nimo-verification-create/SKILL.md)     | fills current-task gaps or the agreed project scope. performance work requires explicit confirmation, then builds cases or routes to optimization. |
