...
|---|---|---|
| Unified entry | guidance/execution intent, explicit wording wins, scope-acceptance rules | [skills/nimo](skills/nimo/SKILL.md) |
| Engineering methods | principles index, Bug/Feature playbooks | [references](skills/nimo/references/principles.md) |
...
| Project verification | feature-map init, patrol maintenance, three-way triage of doc drift / tooling gaps / product defects | [verification-create](skills/verification-create/SKILL.md), [verification-maintain](skills/verification-maintain/SKILL.md) |
| Skill evaluation | isolated baseline/candidate comparison, scoring rules, deterministic assertions & independent judging | [skill-evaluate](skills/skill-evaluate/SKILL.md) |

Runtime verification evidence is kept with the local task and is not part of the nimo installation; unverified scopes belong in the relevant task record.
...
defaults/        Default capability set
docs/            Overall design document and project documentation
```
...
- [Skill evaluation capability](skills/skill-evaluate/SKILL.md): isolation and scoring rules
